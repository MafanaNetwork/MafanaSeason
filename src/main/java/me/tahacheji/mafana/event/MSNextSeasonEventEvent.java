...
public class MSNextSeasonEventEvent extends Event {
    ...
    public MSNextSeasonEventEvent(World world, Season newSeason, Season oldSeason, SeasonEvent newSeasonEvent, SeasonEvent oldSeasonEvent, int day) {
        this.world = world;
